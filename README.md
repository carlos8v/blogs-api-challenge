...
Em cada requisito você encontrará em detalhes o que sua aplicação deverá realizar.
...
:warning: Você pode utilizar `npm test` para rodar todos os testes, mas essa ação pode demorar demais durante o desenvolvimento, deixe que o avaliador determine como está o progresso de seu projeto
