...
describe('8 - Sua aplicação deve ter o endpoint GET `/post`', () => {
  ...
  it('Será validado que é possível listar blogpost com sucesso', () => {
    let token
    return frisby
      .post(`${url}/login`,
        {
  ...
  it('Será validado que não é possível listar blogpost sem token', () => {
    return frisby
      .setup({
        request: {
          headers: {
  ...
  it('Será validado que não é possível listar blogpost com token inválido', () => {
    return frisby
      .setup({
        request: {
          headers: {
